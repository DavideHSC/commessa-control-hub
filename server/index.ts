...
// DEPRECATED V1 ROUTE - import importScrittureRoutes from './routes/importScritture';
// DEPRECATED V1 ROUTE - import importAnagraficheRoutes from './routes/importAnagrafiche';
...
// DEPRECATED V1 ROUTE - import importContiRoutes from './routes/importConti';
import systemRoutes from './routes/system';
import statsRoutes from './routes/stats';
// DEPRECATED V1 ROUTE - import importPrimaNota from './routes/importPrimaNota';
...
// DEPRECATED V1 ROUTE - app.use('/api/import/scritture', importPrimaNota);
// DEPRECATED V1 ROUTE - app.use('/api/import/conti', importContiRoutes);
// DEPRECATED V1 ROUTE - app.use('/api/import/anagrafiche', importAnagraficheRoutes);
...
// DEPRECATED V1 ROUTE - router.use('/import-scritture', importScrittureRoutes);
