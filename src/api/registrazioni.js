 ...
 */
export const getRegistrazioni = async () => {
 ...
 */
export const getRegistrazioneById = async (id) => {
 ...
 */
export const addRegistrazione = async (scritturaData) => {
    const response = await fetch(`${API_BASE_URL}/registrazioni`, {
        method: 'POST',
 ...
 */
export const updateRegistrazione = async (registrazione) => {
 ...
 */
export const deleteRegistrazione = async (id) => {
    const response = await fetch(`${API_BASE_URL}/registrazioni/${id}`, {
        method: 'DELETE',
    });
    if (!response.ok) {
